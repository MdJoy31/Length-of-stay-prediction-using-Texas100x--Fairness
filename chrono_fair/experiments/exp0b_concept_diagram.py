...
def main():
    ...
    axL.text(8.25, 6.4, 'VFR', ha='center', fontsize=14, fontweight='bold')
    axL.text(8.25, 5.7, 'one scalar', ha='center', fontsize=11)
    axL.text(8.25, 5.2, 'fraction of', ha='center', fontsize=11)
    axL.text(8.25, 4.8, 'resamples', ha='center', fontsize=11)
    ...
    axR.text(5, 7.55, 'patients arrive over time t', ha='center', fontsize=11,
              style='italic')
    ...
    fig.text(0.5, 0.5,
              'Static verdict instability becomes time-resolved monitoring.',
              ha='center', fontsize=11, fontweight='bold',
              bbox=dict(boxstyle='rarrow,pad=0.35', facecolor='#fadbd8',
                        edgecolor='#333', linewidth=1.2))
