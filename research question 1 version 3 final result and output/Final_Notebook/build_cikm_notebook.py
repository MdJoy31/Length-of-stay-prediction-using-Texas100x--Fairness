"""
Build CIKM 2026 Submission Notebook — Condensed (~45-50 cells)
Focuses on key results: model performance, fairness analysis,
cross-hospital comparison, and literature comparison.
...
###############################################################################
# CELL 6-7: FEATURE ENGINEERING
###############################################################################
md("## 3. Feature Engineering & Model Training")
...
###############################################################################
# CELL 11-14: FAIRNESS ANALYSIS
###############################################################################
md("## 5. Fairness Analysis — 7 Metrics × 4 Attributes")
...
###############################################################################
# CELL 15-18: VFR STABILITY
###############################################################################
md("## 6. Verdict Stability — VFR Protocol (K=30 Resampling)")
...
###############################################################################
# CELL 19-22: CROSS-HOSPITAL SCALE COMPARISON
###############################################################################
md("## 7. Cross-Hospital Scale Comparison")
...
###############################################################################
# CELL 23-25: CROSS-SITE PORTABILITY
###############################################################################
md("## 8. Cross-Site Portability & Fleiss' κ (K=20 Hospital Clusters)")
...
###############################################################################
# CELL 26-30: FAIRNESS INTERVENTION
###############################################################################
md("## 9. Fairness Intervention — λ-Reweighing + Per-Group Thresholds")
...
# Cell 18 (Per-Group Threshold) is now merged into Cell 17 above
...
###############################################################################
# CELL 31-35: LITERATURE COMPARISON
###############################################################################
md("## 10. Literature Comparison — 14 Prior Studies")
